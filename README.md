...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/bamcmicweb)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bamcmicweb
```

A live public deployment of this template is available at [https://bamcmicweb.templates.workers.dev](https://bamcmicweb.templates.workers.dev)
